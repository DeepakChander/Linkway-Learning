...
export const metadata: Metadata = {
  ...
  description:
    "Launch your data career with Linkway Learning. Industry-driven programs in Data Analytics, Data Science, AI, Business Analytics & Investment Banking. 96.8% placement rate, 400+ hiring partners, mentors from Google, Amazon & Microsoft.",
  keywords: [
