  ...
  return (
    <div className="min-h-screen bg-navy-900 text-white">
      ...
      <section className="py-12 px-6 max-w-3xl mx-auto">
        ...
        <div>
          {/* Section 1 */}
          <AccordionItem title="1. Data Fiduciary" defaultOpen>
          ...
          {/* Section 2 */}
          <AccordionItem title="2. Categories of Personal Data Processed">
            <div className="space-y-6">
              ...
              <div className="rounded-lg border border-white/10 p-4 space-y-2">
                ...
                <ul className="list-disc list-inside space-y-1 pl-2">
                  ...
                  <li>
                    The highest degree or level of education and your field of
                    study
                  </li>
                  <li>Gender</li>
          ...
          {/* Section 3 */}
          <AccordionItem title="3. Purposes and Legal Bases for Processing">
            <div className="space-y-6">
              <p>
              ...
              <div className="overflow-x-auto mt-4">
                <table className="w-full text-sm border border-white/10 rounded-lg">
                  ...
                  <tbody className="divide-y divide-white/10">
                    ...
                    <tr>
                      <td className="p-3">
                        Educational and career opportunities for graduating
                        students
                      </td>
                      <td className="p-3">Consent</td>
                      <td className="p-3">
                        Graduating students&apos; data
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="p-3">
                        Registration data, student data, other data, cookies
                      </td>
                    </tr>
                    <tr>
                      <td className="p-3">
                      ...
                      <td className="p-3">
                        Other data, student data, registration data, cookies
                      </td>
                    </tr>
                    <tr>
                      <td className="p-3">
                      ...
                      <td className="p-3">Legitimate Use</td>
                      <td className="p-3">
                        Other data, student data, registration data, tutor data
                      </td>
                    </tr>
                    <tr>
                      <td className="p-3">
                    ...
                    <tr>
                      <td className="p-3">
                        Planning, reports, and business forecasts
                      </td>
                      <td className="p-3">Legitimate Use</td>
                      <td className="p-3">
                        Registration data, student data, other data, cookies,
                    ...
                    <tr>
                      <td className="p-3">
                        Research, surveys, and contests
                      </td>
                      <td className="p-3">
                        Performance of Contract, Legitimate Use, Consent
                      </td>
                      <td className="p-3">
                        Registration data, student and graduating student data,
                        other data, cookies, tutor data
                      </td>
                    </tr>
                    <tr>
                      <td className="p-3">
                        Record video conferences and chat communications
                      </td>
                      <td className="p-3">Legitimate Use, Consent</td>
                      <td className="p-3">
                        Correspondence and calls between users and support team
                      </td>
                    </tr>
                  </tbody>
                </table>
          ...
          {/* Section 4 */}
          <AccordionItem title="4. How We Share Your Personal Data">
            <div className="space-y-4">
              <p>
              ...
              <div className="space-y-3">
                <div>
                  ...
                  <p>
                    To the extent necessary for them to deliver and support the
                ...
                <div>
                  ...
                  <p>
                    Other entities within the Linkway Learning corporate group,
                    solely to enable seamless Service provision.
                  </p>
                </div>
                <div>
                  <h4 className="text-white font-semibold">
                    Educational & Career Partners
                  </h4>
                  <p>
                    Organizations that help identify and create learning or job
                ...
                <div>
                  ...
                  <p>
                    When strictly necessary to comply with legal or regulatory
                    obligations, or to respond to formal inquiries from
                ...
                <div>
                  ...
                  <p>
                    Lenders or other financial service providers, where needed to
                    facilitate payments, loans, or related services.
                  </p>
                </div>
                <div>
                  <h4 className="text-white font-semibold">
                  ...
                  <p>
                    In connection with a sale, merger, corporate restructuring,
                    or transfer of all or part of our business, assets, or
              ...
              <p>
                ...
                functions and are prohibited from using it for any other
                purpose.
              </p>

              <div className="mt-4 rounded-lg border border-white/10 p-4 space-y-2">
                <h4 className="text-white font-semibold">
                  Payment Processing
                </h4>
                <p>
                  ...
                  completed, we only receive confirmation of the transaction
                  status.
                </p>
                <ul className="list-disc list-inside space-y-1 pl-2">
                  <li>
                    We do not collect, access, or store any of your payment
                    details (e.g., card numbers, UPI IDs, bank account
                    information).
                  </li>
                  <li>
                    All payment processing is handled directly by the
                    third-party provider under its own privacy policy.
                  </li>
                </ul>
              </div>
            </div>
          ...
          {/* Section 5 */}
          <AccordionItem title="5. External Links & Third-Party Services">
            <div className="space-y-4">
              <p>
              ...
              <ul className="list-disc list-inside space-y-2 pl-2">
                <li>
                  ...
                  These third-party providers may require you to register
                  independently, and they operate under their own terms and
                  privacy policies.
                </li>
                <li>
                  <span className="text-white font-medium">
                  ...
                  Linkway Learning does not control, endorse, or assume any
                  liability for the content, privacy practices, or security
                  measures of these external sites and services.
                </li>
                <li>
                  <span className="text-white font-medium">
                    Different Privacy Policies:
                  </span>{" "}
                  This Privacy Policy does not cover how those third parties
                  collect, use, or share your personal data.
                </li>
              </ul>
          ...
          {/* Section 6 */}
          <AccordionItem title="6. Data Storage, Transfer, and Protection">
            <div className="space-y-6">
              <div>
                <h4 className="text-white font-semibold">
                  6.1. Transfers Outside India
                </h4>
                <p className="mt-2">
                ...
                <ul className="list-disc list-inside space-y-1 pl-2 mt-1">
                  <li>
                    Adequate data protection standards as recognized by the
                    Central Government of India
                  </li>
                  <li>
                    Written agreements with recipients requiring the same level
                    of protection
                  </li>
                  <li>
                    Your consent for transfers where required by applicable law
                  </li>
                  <li>
                    Other transfer mechanisms approved under Indian law
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <p className="mt-2">
                  ...
                  organizational safeguards in compliance with the IT Act and
                  SPDI Rules:
                </p>
                <ul className="list-disc list-inside space-y-1 pl-2 mt-2">
                  <li>
                  ...
                  <li>
                    ...
                    Encryption in transit and at rest, firewalls, intrusion
                    detection, and regular security testing
                  </li>
                  <li>
                    <span className="text-white font-medium">
                      Organizational controls:
                    </span>{" "}
                    Access restricted on a &quot;need-to-know&quot; basis, staff
                    training, and formal security policies
                  </li>
                </ul>
                <p className="mt-2 text-sm">
                  ...
                  you transmit to us over the Internet will never be
                  intercepted.
                </p>
              </div>
            </div>
          ...
          {/* Section 7 */}
          <AccordionItem title="7. Rights of Data Principals">
            <div className="space-y-4">
              <p>
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-sm border border-white/10 rounded-lg">
                  ...
                  <tbody className="divide-y divide-white/10">
                    <tr>
                      <td className="p-3 text-white font-medium align-top">
                        Access Information
                      </td>
                      <td className="p-3">
                        Request confirmation of whether we are processing your
                        personal data, and if so, obtain a summary of the data
                    ...
                    <tr>
                      ...
                      <td className="p-3">
                        ...
                        completion of incomplete data, updating of data, and
                        erasure of data no longer necessary for its purpose.
                      </td>
                    </tr>
                    <tr>
                      <td className="p-3 text-white font-medium align-top">
                      ...
                      <td className="p-3">
                        Register a grievance with Linkway Learning regarding any
                    ...
                    <tr>
                      ...
                      <td className="p-3">
                        Nominate any other individual who shall, in the event of
                        your death or incapacity, exercise your rights as a Data
                        Principal.
                      </td>
                    </tr>
                    <tr>
                      ...
                      <td className="p-3">
                        Withdraw consent at any time. Withdrawal shall not
          ...
          {/* Section 8 */}
          <AccordionItem title="8. Withdrawal of Consent">
            <div className="space-y-4">
              <p>
          ...
          {/* Section 9 */}
          <AccordionItem title="9. Grievance Redressal">
            <div className="space-y-4">
              <p>
          ...
          {/* Section 10 */}
          <AccordionItem title="10. Necessity of Providing Personal Data">
            <div className="space-y-4">
              <p>
          ...
          {/* Section 11 */}
          <AccordionItem title="11. Children's Privacy">
            <div className="space-y-4">
              <p>
                <span className="text-white font-medium">
              ...
              <p>
                ...
                children, or engage in targeted advertising directed at
                children.
              </p>
            </div>
          </AccordionItem>
          ...
          {/* Section 12 */}
          <AccordionItem title="12. Duties of Data Principals">
            <div className="space-y-4">
              <p>
                Under the DPDP Act, Data Principals have the following duties:
              </p>
              <ul className="list-disc list-inside space-y-2 pl-2">
                <li>
                  Comply with provisions of applicable law while exercising your
                  rights.
                </li>
                <li>
                  Do not register a false or frivolous grievance or complaint
                  with Linkway Learning or the Data Protection Board of India.
                </li>
                <li>
                  Furnish only verifiable and authentic information when
                  exercising your right to correction or erasure.
                </li>
                <li>
                  Comply with all applicable laws in respect of any matter
          ...
          {/* Section 13 */}
          <AccordionItem title="13. Changes to This Privacy Policy">
            <div className="space-y-4">
              <p>
          ...
          {/* Section 14 */}
          <AccordionItem title="14. Difficulties in Accessing This Privacy Policy">
            <div className="space-y-4">
              <p>
          ...
          {/* Section 15 */}
          <AccordionItem title="15. India-Specific Privacy Provisions">
            <div className="space-y-6">
              <div>
                <h4 className="text-white font-semibold">
                  A. Applicability of Indian Data Protection Laws
                </h4>
                <p className="mt-2">
              ...
              <div>
                ...
                <p className="mt-2">
                  Under the SPDI Rules, &quot;Sensitive Personal Data or
                  Information&quot; includes:
                </p>
                <ul className="list-disc list-inside space-y-1 pl-2 mt-2">
                  <li>Passwords</li>
                  <li>
                    Financial information (bank account, credit/debit card, or
              ...
              <div>
                <h4 className="text-white font-semibold">
                  C. Data Protection Officer / Grievance Officer
                </h4>
                <p className="mt-2">
                  In compliance with the IT Act and the DPDP Act, Linkway
                  Learning has appointed a Data Protection Officer / Grievance
                  Officer.
                </p>
                <p className="mt-2">
                  <span className="text-white font-medium">E-mail:</span>{" "}
