...
export const metadata: Metadata = {
  ...
  description:
    "Frequently asked questions about Linkway Learning's programs, placement assistance, pricing, certification, and more. Get all your answers here.",
    ...
    <>
      <FAQJsonLd
        faqs={[
          ...
          { question: "How does placement assistance work?", answer: "After completing assignments, projects, and assessments, we guarantee up to 10 interview opportunities with our 400+ hiring partners." },
