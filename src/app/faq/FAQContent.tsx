    ...
    items: [
      {
        ...
        a: "Once you complete all assignments, projects, and assessments, we guarantee up to 10 interview opportunities with our hiring partners. Our team works with you until something sticks.",
      },
      {
