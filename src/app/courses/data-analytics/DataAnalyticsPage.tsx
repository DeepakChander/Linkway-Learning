  ...
  return (
    ...
    <div className="min-h-screen bg-white text-navy-900 selection:bg-orange-500/20 overflow-x-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center py-24 lg:py-0">
            ...
            <div className="pt-8 lg:pt-0">
              ...
              <motion.div className="mt-8 flex flex-wrap items-center gap-3" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.55 }}>
                <Magnetic>
                  <motion.button onClick={() => openPurchase("Data Analytics")} className="group relative px-7 py-3.5 rounded-xl font-semibold text-sm overflow-hidden cursor-pointer" style={{ backgroundColor: BRAND_ORANGE }} whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.97 }}>
      ...
      <CertificationDisplay
        ...
        cert2Image="/images/certificates/Data-Analytics.jpeg"
        cert2Alt="Data Analytics Certificate of Completion"
        cert2Label="Linkway Learning"
        cert2Sub="Data Analytics Certificate"
      />
