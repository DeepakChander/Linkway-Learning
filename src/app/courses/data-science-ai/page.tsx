...
export const metadata: Metadata = {
  ...
  description:
    "From Python fundamentals to deploying production ML models. Build neural networks, NLP systems, and generative AI applications. 100% placement. Linkway Learning.",
  ...
  openGraph: {
    ...
    description: "Build neural networks, NLP systems, and generative AI apps. 100% placement.",
