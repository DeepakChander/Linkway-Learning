...
function DashboardPreview() {
  ...
  const kpis = [
    { label: "Revenue YTD", value: "\u20B912.4Cr", change: "+18.4%", up: true },
    { label: "Avg Deal Size", value: "\u20B98.6L", change: "+7.2%", up: true },
    { label: "Churn Rate", value: "3.8%", change: "-2.1%", up: false },
    { label: "ROI", value: "142%", change: "+24.6%", up: true },
  ];
    ...
    <div ref={ref} className="rounded-2xl overflow-hidden border border-white/[0.08] shadow-2xl bg-[#0d1117]">
      ...
      <div className="flex items-center justify-between px-5 py-3 bg-[#1a1e2e] border-b border-white/[0.06]">
        <div className="flex items-center gap-3">
          ...
          <span className="text-xs font-mono text-gray-500">business_analytics.py</span>
        </div>
...
const MODULE_DATA = [
  {
    ...
    lightBg: "#ecfdf5",
    topics: [
      "XLOOKUP, LAMBDA, LET & dynamic array formulas",
  ...
  {
    id: 2,
    title: "SQL & Cloud Data Platforms",
    subtitle: "Query any database, anywhere",
    ...
    topics: [
      ...
      "Window functions for rankings, running totals & moving averages",
      "Database design, normalization & indexing",
      "Cloud data warehouses - BigQuery & Snowflake",
      "Stored procedures, views & query optimization",
      "Data quality frameworks & governance basics",
    ],
  ...
  },
  {
    ...
    topics: [
      ...
      "Pandas DataFrames - cleaning, merging, grouping, pivoting",
      "NumPy arrays & vectorized operations for speed",
      "Matplotlib & Seaborn for publication-quality charts",
      "Automating Excel reports, email alerts & data pipelines",
      "Web scraping for competitive intelligence & market research",
    ],
  ...
  },
  {
    ...
    topics: [
      ...
      "Building multi-page interactive reports with drill-through",
      "Power Query M language for complex ETL pipelines",
      "Row-level security & workspace governance",
      "Dataflows, incremental refresh & performance tuning",
      "Power BI Service - publishing, sharing & embedded analytics",
    ],
  ...
  },
  {
    ...
    subtitle: "Turn insights into executive action",
    ...
    lightBg: "#eff6ff",
    topics: [
      "Connecting to live & extract data sources across platforms",
      "Calculated fields, LOD expressions & table calculations",
      "Geospatial mapping & custom geocoding for regional analytics",
      "Data storytelling - narrative structure, audience design",
      "Building executive presentations that drive decisions",
      "Publishing to Tableau Server & Tableau Public portfolio",
    ],
  ...
  },
  {
    ...
    subtitle: "Forecast, test & model business outcomes",
    ...
    lightBg: "#fdf2f8",
    topics: [
      "Descriptive stats - central tendency, dispersion & distributions",
      "Hypothesis testing & A/B testing for business experimentation",
      "Linear & logistic regression for business predictions",
      "Time series forecasting - ARIMA, SARIMA & Prophet",
      "Customer segmentation - RFM analysis & K-Means clustering",
      "ROI measurement & statistical significance for decisions",
    ],
    icon: (<img src="/images/tools/scikit-learn.png" alt="Statistics" className="w-7 h-7 object-contain drop-shadow-sm" />),
  },
]
        ...
        <ScrollReveal>
          <div className="text-center mb-16">
            ...
            >
              ...
              <span className="text-xs font-semibold text-gray-600 tracking-wide">7 Modules · 42+ Topics · 24 Weeks</span>
            ...
            <p className="mt-5 text-gray-500 text-lg max-w-xl mx-auto leading-relaxed">
              Each module builds on the last - from Excel to AI-powered analytics. Click any module to explore what&apos;s inside.
            </p>
          </div>
        </ScrollReveal>
...
export default function BusinessAnalyticsPage() {
  ...
  const curriculum = [
    {
      ...
      weeks: 5,
      projects: 4,
      description: "Every great business analyst starts by mastering the fundamentals that organizations depend on. This module transforms you into a professional who understands the full scope of business analysis - from BABOK principles to requirement gathering, stakeholder management, and building Excel dashboards that executives actually use. You will walk out thinking, speaking, and documenting like a seasoned BA.",
      outcomes: [
        "Understanding the role, scope, and strategic impact of Business Analysts in modern organizations",
        "BABOK fundamentals: core principles of requirement analysis and stakeholder management",
        "Excel mastery: pivot tables, VLOOKUP, advanced formulas, and executive-grade dashboards",
        "Requirement gathering techniques: stakeholder interviews, workshops, surveys, and document analysis",
        "Professional documentation: crafting BRDs, FRDs, and use-case diagrams that drive clarity",
        "Building structured requirement specifications that align teams and accelerate delivery",
      ],
      tools: ["Excel", "JIRA", "Confluence", "MS Project", "Google Sheets"],
      iconPath: "M3 10h18M3 14h18M9 4v16M15 4v16M3 6a2 2 0 012-2h14a2 2 0 012 2v12a2 2 0 01-2 2H5a2 2 0 01-2-2V6z",
    },
    {
      title: "Process Modeling & Requirement Elicitation",
      weeks: 5,
      projects: 4,
      description: "The best analysts do not just document what exists - they architect what should exist. This module gives you the power to map complex business processes, write user stories that developers love, and build traceability matrices that keep entire projects on track. You will learn to see the gap between where a business is and where it needs to be - and design the bridge.",
      outcomes: [
        "Process modeling with BPMN, flowcharts, and UML diagrams for crystal-clear communication",
        "Writing compelling user stories with precise acceptance criteria using the INVEST model",
        "Building and maintaining Requirements Traceability Matrices (RTM) for end-to-end visibility",
        "Stakeholder analysis and prioritization: identifying who matters and what they need",
        "Mapping As-Is vs. To-Be processes to uncover transformation opportunities",
        "Distinguishing and documenting functional vs. non-functional requirements with precision",
      ],
      tools: ["JIRA", "Confluence", "Miro", "Lucidchart", "MS Visio"],
    ...
    },
    {
      ...
      weeks: 6,
      projects: 5,
      description: "Data without insight is just noise. This module turns you into the person who extracts meaning from chaos - writing SQL queries that pull exactly the right data, building Power BI and Tableau dashboards that tell stories at a glance, and applying business statistics that separate gut feelings from evidence-based decisions. This is where you become indispensable.",
      outcomes: [
        "Business statistics: descriptive and inferential techniques for data-driven decisions",
        "SQL fundamentals: SELECT, JOINs, aggregations, subqueries, and complex data retrieval",
        "Power BI and Tableau: building interactive dashboards that stakeholders actually use",
        "Dashboard design principles and the art of storytelling with data",
        "Defining, tracking, and analyzing KPIs and business performance trends",
        "Data-driven forecasting techniques that turn historical patterns into strategic foresight",
      ],
      tools: ["SQL", "Power BI", "Tableau", "Excel", "Python", "Google BigQuery"],
      iconPath: "M8 9l3 3-3 3m5 0h3M5 20h14a2 2 0 002-2V6a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z",
    },
    {
      title: "Agile Business Analysis & Collaboration Tools",
      weeks: 5,
      projects: 4,
      description: "The corporate world has gone Agile - and business analysts are at the heart of it. This module immerses you in real Agile workflows: standing up in daily scrums, grooming backlogs, planning sprints, and using prioritization frameworks that ship the right features first. You will not just learn Agile theory - you will live it, using the same tools that drive teams at top tech companies.",
      outcomes: [
        "Agile vs. Waterfall: understanding when and why each methodology wins",
        "Mastering Agile ceremonies: standups, retrospectives, sprint reviews, and backlog grooming",
        "Hands-on with JIRA, Confluence, and Miro for seamless team collaboration",
        "Prioritization frameworks: MoSCoW method and Kano model for smarter feature decisions",
        "Sprint planning, epic breakdown, and managing product backlogs with confidence",
        "Becoming the bridge between business stakeholders and development teams in Agile environments",
      ],
      tools: ["JIRA", "Confluence", "Miro", "Trello", "MS Teams"],
      iconPath: "M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z",
    },
    {
      title: "Strategy & Domain Applications",
      weeks: 6,
      projects: 5,
      description: "Strategy separates analysts who report numbers from those who shape business direction. This module arms you with powerful frameworks like SWOT, PESTLE, and Balanced Scorecard, then throws you into real-world case studies across Banking, E-Commerce, Healthcare, HR, Telecom, and Retail. You will solve the exact problems companies pay consultants lakhs to figure out.",
      outcomes: [
        "Business strategy frameworks: SWOT analysis, PESTLE, and Balanced Scorecard in action",
        "KPI development, performance tracking, and building measurement systems that matter",
        "Product management essentials: roadmaps, feature prioritization, and MVP design",
        "Domain case studies: Banking (loan risk), E-Commerce (pricing & CLV), Healthcare (patient flow)",
        "Industry deep dives: Telecom (churn prevention), Retail (omnichannel funnels), HR (attrition analysis)",
        "B2B Sales pipeline forecasting and Marketing ROAS optimization with real datasets",
      ],
    ...
    {
      title: "Advanced Business Analysis & Tools",
      weeks: 5,
      projects: 4,
      description: "Senior analysts handle complexity that others shy away from. This module elevates your skillset to enterprise-grade - teaching you risk management, advanced gap analysis, data-driven forecasting, and even the basics of Robotic Process Automation. You will learn to navigate governance frameworks and documentation standards that large organizations demand.",
      outcomes: [
        "Risk management and business continuity planning for enterprise-scale projects",
        "Advanced requirement analysis: gap analysis, impact assessment, and change management",
        "Data-driven forecasting using Excel models and BI-powered prediction techniques",
        "Robotic Process Automation (RPA) fundamentals: identifying and automating repetitive workflows",
        "Documentation governance: standards, version control, and compliance policies",
        "Managing complex stakeholder landscapes across cross-functional enterprise initiatives",
      ],
      tools: ["Excel", "Power BI", "JIRA", "Confluence", "Python"],
      iconPath: "M3 3v18h18M7 16l4-4 4 4 6-6m0 0v4m0-4h-4",
    },
    {
      title: "Certification Prep & Career Launchpad",
      weeks: 4,
      projects: 3,
      description: "You have built the skills - now it is time to prove them and land the role you deserve. This final module prepares you for globally recognized certifications like ECBA and CCBA, polishes your professional brand, and puts you through rigorous mock interviews. You will walk into your next interview with a portfolio, credentials, and the confidence of someone who has already done the work.",
      outcomes: [
        "Certification preparation: ECBA and CCBA-aligned practice tests and exam strategies",
        "Resume optimization and LinkedIn profile enhancement that attract top recruiters",
        "Portfolio building: showcasing requirement docs, dashboards, RTMs, and case study solutions",
        "Mock interview training: HR rounds, technical BA scenarios, and case study presentations",
        "Personal branding: positioning yourself as a high-impact business analyst in the job market",
        "Direct recruiter access, industry mentorship, and dedicated placement support",
      ],
      tools: ["LinkedIn", "GitHub", "Notion", "Google Docs", "Canva"],
      iconPath: "M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z",
    },
  ]

  const tools = [
    // Row 1 - Core BI & Visualization (12)
  ...
  const industryProjects = [
    // Strategy & Consulting
    { title: "Market Entry Strategy Dashboard", domain: "Strategy", tags: ["Power BI", "Python", "Excel"], color: "#F97316", desc: "Data-driven market assessment for $50M expansion decision" },
    { title: "Competitive Intelligence Platform", domain: "Consulting", tags: ["Tableau", "SQL", "Python"], color: "#3B82F6", desc: "Real-time competitor tracking across 15 market segments" },
    { title: "Business Process Optimization", domain: "Operations", tags: ["Power BI", "SQL", "Excel"], color: "#8B5CF6", desc: "Process mining reducing operational costs by 22%" },
    { title: "M&A Due Diligence Analytics", domain: "Strategy", tags: ["Excel", "Python", "Power BI"], color: "#06B6D4", desc: "Financial modeling for $120M acquisition target" },
    // Finance & Banking
    { title: "Revenue Optimization Dashboard", domain: "Finance", tags: ["Power BI", "SQL", "Python"], color: "#EF4444", desc: "C-suite dashboard tracking $4.2M pipeline across 3 business units" },
    { title: "Credit Risk Assessment Model", domain: "Banking", tags: ["Python", "Excel", "Tableau"], color: "#F59E0B", desc: "Risk scoring model reducing NPAs by 18%" },
    { title: "Portfolio Performance Tracker", domain: "Investment", tags: ["Power BI", "Python", "Excel"], color: "#10B981", desc: "Multi-asset portfolio analytics with real-time NAV tracking" },
    { title: "Budget vs Actual Variance Analysis", domain: "Finance", tags: ["Excel", "Power BI", "SQL"], color: "#3B82F6", desc: "Automated variance reporting for 12 department heads" },
    // Marketing & CRM
    { title: "Customer Segmentation Engine", domain: "Marketing", tags: ["Python", "SQL", "Tableau"], color: "#EC4899", desc: "RFM-based segmentation driving 34% campaign uplift" },
    { title: "Marketing ROI Attribution", domain: "Marketing", tags: ["Google Analytics", "SQL", "Power BI"], color: "#14B8A6", desc: "Multi-touch attribution increasing ROAS by 28%" },
    { title: "Customer Churn Prediction", domain: "CRM", tags: ["Python", "Scikit-learn", "Tableau"], color: "#6366F1", desc: "Predictive model identifying 234 at-risk accounts early" },
    { title: "Campaign Performance Analytics", domain: "AdTech", tags: ["Google Analytics", "Tableau", "SQL"], color: "#F97316", desc: "Real-time campaign optimization across 8 channels" },
    // Supply Chain & Operations
    { title: "Supply Chain KPI Dashboard", domain: "Supply Chain", tags: ["Power BI", "SQL", "Python"], color: "#0EA5E9", desc: "End-to-end visibility reducing supply delays by 18%" },
    { title: "Inventory Optimization Model", domain: "Operations", tags: ["Python", "Excel", "Tableau"], color: "#84CC16", desc: "Demand-driven inventory reducing holding costs 25%" },
    { title: "Demand Forecasting System", domain: "Supply Chain", tags: ["Python", "Power BI", "SQL"], color: "#A855F7", desc: "Time-series model with 92% forecast accuracy" },
    // HR & People Analytics
    { title: "Employee Attrition Analysis", domain: "HR", tags: ["Python", "Power BI", "Excel"], color: "#EF4444", desc: "Predicting turnover risk 6 months in advance" },
    { title: "Workforce Planning Dashboard", domain: "People Analytics", tags: ["Power BI", "SQL", "Excel"], color: "#3B82F6", desc: "Capacity planning for 5,000+ employee organization" },
    { title: "Compensation Benchmarking Tool", domain: "HR", tags: ["Tableau", "SQL", "Python"], color: "#F59E0B", desc: "Market-aligned pay bands across 200+ roles" },
    // Retail & E-commerce
    { title: "Sales Performance Analytics", domain: "Retail", tags: ["Tableau", "SQL", "Power BI"], color: "#10B981", desc: "Store-level analytics improving same-store sales 15%" },
    { title: "Pricing Strategy Optimizer", domain: "E-commerce", tags: ["Python", "Excel", "Tableau"], color: "#8B5CF6", desc: "Dynamic pricing model boosting margins by 12%" },
    { title: "Store Location Intelligence", domain: "Retail", tags: ["Tableau", "Python", "SQL"], color: "#EC4899", desc: "Geospatial analysis optimizing new store placement" },
    // Healthcare & Insurance
    { title: "Claims Analytics Dashboard", domain: "Insurance", tags: ["Power BI", "SQL", "Python"], color: "#14B8A6", desc: "Fraud detection saving $3.2M in false claims annually" },
    { title: "Patient Satisfaction Analysis", domain: "Healthcare", tags: ["Tableau", "SQL", "Python"], color: "#6366F1", desc: "NPS analytics improving patient retention by 22%" },
    // SaaS & Product
    { title: "Product Analytics Dashboard", domain: "SaaS", tags: ["SQL", "Tableau", "Python"], color: "#0EA5E9", desc: "Self-serve analytics for 50+ product teams" },
    { title: "Executive KPI Dashboard", domain: "Business", tags: ["Power BI", "Excel", "SQL"], color: "#F97316", desc: "Automated 12 KPI alerts serving 5 department heads daily" },
    { title: "User Engagement Scoring", domain: "Product", tags: ["Python", "SQL", "Looker"], color: "#A855F7", desc: "Behavioral scoring driving 28% feature adoption" },
  ];
  ...
  const faqs = [
    ...
    { question: "How does Linkway Learning help me get hired?", answer: "As a 100% placement program, we provide end-to-end career support including resume building, LinkedIn optimization, mock case study interviews, and direct introductions to 200+ hiring partners in analytics, consulting, and strategy." },
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center py-24 lg:py-0">
            ...
            <div className="pt-8 lg:pt-0">
              ...
              >
                ...
                <TypeWriter
                  words={["Power BI & Tableau", "SQL & Python", "Predictive Analytics", "AI for Business", "Data Storytelling"]}
              ...
              <motion.div className="mt-8 flex flex-wrap items-center gap-3" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.55 }}>
                <Magnetic>
                  <motion.button onClick={() => openPurchase("Business Analytics")} className="group relative px-7 py-3.5 rounded-xl font-semibold text-sm overflow-hidden cursor-pointer" style={{ backgroundColor: BRAND_ORANGE }} whileHover={{ scale: 1.03 }} whileTap={{ scale: 0.97 }}>
      ...
      <section className="relative py-20 md:py-28 overflow-hidden bg-[#fafbfc]">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-16 md:mb-20">
            ...
            >
              Our Business Analytics program equips you with industry-ready skills through advanced BI tools and expert support.
            </motion.p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 sm:gap-4 md:gap-5">
            {[
              ...
              { icon: "video", label: "200+ Hours Content", desc: "Self-paced learning" },
              { icon: "live", label: "300+ Live Hours", desc: "Interactive classes" },
              { icon: "path", label: "Personalized Paths", desc: "Tailored to your goals" },
              { icon: "hackathon", label: "Live Case Studies", desc: "Real business scenarios" },
              ...
              { icon: "workshop", label: "Leadership Workshops", desc: "Extra learning sessions" },
              ...
              { icon: "interview", label: "Mock Case Interviews", desc: "Case study practice" },
              { icon: "material", label: "Course Materials", desc: "Lifetime access" },
              { icon: "support", label: "24/7 Support", desc: "Always here for you" },
              { icon: "certificate", label: "BI Certifications", desc: "Industry-recognized" },
              { icon: "flexible", label: "Flexible Schedule", desc: "Learn at your pace" },
              { icon: "project", label: "Real Business Projects", desc: "Portfolio-ready work" },
        ...
        <div className="max-w-6xl mx-auto relative z-10 px-6">
          <ScrollReveal>
            ...
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-white leading-tight">
              <span className="text-white">25+ Industry-Specific </span>
