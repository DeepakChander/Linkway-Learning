...
export default function BusinessAnalyticsPage() {
  ...
  const curriculum = [
    ...
    },
    {
      ...
      weeks: 4,
      projects: 5,
      description: "SQL is the universal language of business data. You will query CRM systems, sales databases, and cloud warehouses with confidence. By the end, you will write production-grade queries on BigQuery and understand modern data infrastructure that powers every Fortune 500 company.",
      outcomes: [
        "SQL fundamentals: SELECT, WHERE, GROUP BY, HAVING, ORDER BY",
        "JOINs mastery: combining CRM, sales, marketing & finance tables",
        "Window functions for rankings, running totals & moving averages",
        "CTEs, subqueries & complex multi-step business analysis",
        "Cloud data warehouses: Google BigQuery & Snowflake essentials",
        "Database design, normalization, indexing & data quality frameworks",
      ],
      tools: ["MySQL", "PostgreSQL", "Google BigQuery"],
    ...
    },
    {
      ...
      weeks: 3,
      projects: 4,
      description: "Learn Python like a business analyst, not a software engineer. Every line of code serves a business purpose -- cleaning messy CRM exports, automating weekly reports, scraping competitor pricing, and building visualizations that tell stories. No CS degree required.",
      outcomes: [
        "Python fundamentals: variables, loops, functions & data structures",
        "Pandas DataFrames: cleaning, merging, grouping & pivoting business data",
        "NumPy arrays & vectorized operations for fast numerical analysis",
        "Matplotlib & Seaborn for publication-quality business visualizations",
        "Automating Excel reports, email alerts & scheduled data pipelines",
        "Web scraping for competitive intelligence & market research",
      ],
    ...
    },
    {
      ...
      weeks: 4,
      projects: 5,
      description: "Become the Power BI expert every organization is hiring for. Build enterprise-grade dashboards, master DAX formulas, and create interactive reports that C-suite executives rely on daily. This module alone makes you indispensable in any data-driven company.",
      outcomes: [
        "Power BI Desktop: data modeling, relationships & star schema design",
        "DAX deep dive: calculated columns, measures & time intelligence",
        "Power Query M language for complex ETL & data transformation",
        "Row-level security, workspaces & governance for enterprise deployment",
        "Dataflows, incremental refresh & performance optimization",
        "Power BI Service: publishing, scheduling, alerts & embedded analytics",
      ],
    ...
    },
    {
      ...
      weeks: 3,
      projects: 4,
      description: "Visualization is only half the battle -- the other half is storytelling. Master Tableau’s powerful engine and learn the art of building narratives that influence boardroom decisions. You will not just show data, you will drive action with it.",
      outcomes: [
        "Connecting to live and extract data sources across platforms",
        "Calculated fields, LOD expressions & advanced table calculations",
        "Geospatial mapping & custom geocoding for regional business analytics",
        "Data storytelling: narrative structure, audience design & persuasion",
        "Building executive presentations that drive strategic decisions",
        "Publishing to Tableau Server & building a Tableau Public portfolio",
      ],
    ...
    {
      title: "Statistics, Forecasting & Predictive Analytics",
      weeks: 4,
      projects: 5,
      description: "This is where business analysts become strategic advisors. Learn to forecast revenue, predict customer churn, run A/B tests that save millions, and segment customers for targeted campaigns. Every model is built on real business data with Python.",
      outcomes: [
        "Descriptive statistics: distributions, central tendency & dispersion",
        "Hypothesis testing & A/B testing for business experimentation",
        "Linear & logistic regression for revenue and churn prediction",
        "Time series forecasting: ARIMA, SARIMA & Facebook Prophet",
        "Customer segmentation: RFM analysis & K-Means clustering",
        "ROI measurement, statistical significance & confidence intervals",
      ],
      tools: ["Python", "Pandas", "Scikit-learn", "SciPy", "Seaborn"],
      iconPath: "M3 3v18h18M7 16l4-4 4 4 6-6m0 0v4m0-4h-4",
    },
    {
      title: "AI-Powered Analytics & Capstone",
      weeks: 3,
      projects: 3,
      description: "In 2026, the best analysts use AI as a force multiplier. Learn to leverage generative AI for automated reporting, prompt engineering for data analysis, and AI copilots across every tool you have mastered. Then bring everything together in a capstone project presented to an industry panel.",
      outcomes: [
        "Generative AI for analysts: prompt engineering for data workflows",
        "AI-augmented dashboards & automated insight generation",
        "Cloud BI platforms: AWS QuickSight & Google Looker Studio",
        "Capstone: scope, plan & execute a full business analytics project",
        "Build end-to-end solution: raw data to executive dashboard with AI",
        "Present findings to industry panel & receive actionable feedback",
      ],
      tools: ["Python", "Power BI", "AWS QuickSight", "Google Analytics", "Looker"],
