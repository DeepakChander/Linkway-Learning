...
const courses = [
  ...
  },
  {
    ...
    slug: "/courses/business-intelligence",
...
const rows = [
  ...
  { label: "Skill Level", values: ["Beginner to Advanced", "Zero to Expert", "Professional Upskilling"] },
  { label: "Best For", values: ["Career switchers, graduates", "Aspiring data scientists", "Working professionals, MBAs"] },
  { label: "Core Focus", values: ["Analysis & Visualization", "Full AI/ML lifecycle", "BI tools & business strategy"] },
  { label: "Key Tools", values: ["Excel, SQL, Python, Tableau", "TensorFlow, PyTorch, Docker, AWS", "Power BI, Looker, SQL, Tableau"] },
  { label: "Modules", values: ["3 Phases", "7 Modules", "7 Modules"] },
  { label: "Projects", values: ["4+ hands-on", "7+ capstones + case studies", "6+ business cases"] },
  { label: "Top Roles", values: ["Data Analyst, BI Analyst", "Data Scientist, ML Engineer", "Business Analyst, Analytics Manager"] },
  { label: "Certification", values: ["Linkway + Microsoft Azure AI", "Linkway + Microsoft Azure AI", "Linkway + Microsoft Azure AI"] },
  { label: "Placement", values: ["Placement Assistance", "Placement Assistance", "Placement Assistance"] },
];
