...
export const COURSES: Course[] = [
  ...
  // -------------------------------------------------------------------------
  {
    ...
    heroDescription:
      "Launch your analytics career in just 6 months. Learn Excel, SQL, Python, R, Tableau, Power BI, and machine learning - with hands-on projects and guaranteed placement support.",
    color: "#4F46E5",
    icon: "BarChart3",
    whoIsThisFor: [
      {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "Yes. The curriculum covers every skill that hiring managers look for - Excel, SQL, Python, Tableau/Power BI, statistics, and machine learning. Combined with our placement support, mock interviews, and resume building, you will be fully prepared.",
      },
      {
  ...
  // -------------------------------------------------------------------------
  {
    ...
    heroDescription:
      "Become a complete data scientist and AI engineer in 12 months. Master Python, machine learning, deep learning, NLP, Generative AI, MLOps, and cloud deployment - with 7+ real-world projects and guaranteed placement.",
    color: "#7C3AED",
    icon: "Brain",
    whoIsThisFor: [
      {
    ...
    questions: [
      {
        ...
        a: "Linkway Learning is a career-focused data science and analytics institute that provides industry-aligned courses, hands-on projects, and guaranteed placement support. We help learners transition into high-growth data careers through structured programs taught by industry practitioners.",
      },
      {
