...
const toolImageMap: Record<string, string> = {
  ...
  "PostgreSQL": "/images/tools/sql.png",
  ...
  "Excel Advanced": "/images/tools/excel.png",
  "Scikit-learn": "/images/tools/scikit-learn.png",
  "Scikit-Learn": "/images/tools/scikit-learn.png",
  "XGBoost": "/images/tools/scikit-learn.png",
  // New SVGs
  ...
  "GitHub": "/images/tools/git.svg",
  "GitHub Portfolio": "/images/tools/git.svg",
  ...
  "Google BigQuery": "/images/tools/gcp.svg",
  "BigQuery": "/images/tools/gcp.svg",
  "Google Data Studio": "/images/tools/google-analytics.svg",
