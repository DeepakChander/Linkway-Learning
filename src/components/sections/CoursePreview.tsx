...
const courses = [
  ...
  },
  {
    ...
    description: "Learn to design, build, and deploy AI agents that think, plan, and execute. From prompt engineering to agentic workflows - this is the future of AI, and you'll be building it.",
    icon: Brain,
  ...
  },
  {
    ...
    usps: [
      { icon: Rocket, label: "15+ Finance Projects" },
      { icon: Briefcase, label: "30+ Hiring Partners" },
      { icon: Users, label: "1:1 Mentorship" },
      { icon: MessageCircle, label: "Daily Doubt Clearing" },
      { icon: Target, label: "150+ Hours of Learning" },
      { icon: GraduationCap, label: "Placement Assistance" },
    ],
